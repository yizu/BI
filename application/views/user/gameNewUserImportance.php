...
<div class="bodywrapper">
    ...
    <div class="overviewhead">
        <div class="overviewhead">
            ...
            <form action="<?php echo site_url('Game/GameCommon/findNewUserImportance') ?>" method="post" onsubmit="return check()">
                &nbsp;&nbsp;&nbsp;&nbsp;时间段：
        ...
        <form id="download" action="<?php echo site_url('Export/daochu/') ?>" method="post" >
            ...
            ?>'/>
            <input id="title" type="hidden" name="title" value="<?php echo '时间|平台|渠道|新增玩家|7日内平均贡献|14日内平均贡献|30日内平均贡献|60日内平均贡献,date|roofGarden|channelname|zhucerenshu|qitian|shisitian|sanshitian|liushitian' ?>"/>
        </form>
        <br clear="all" />
        <br clear="all" />
                        ...
                        if ($newUserImportance) {
                            foreach ($newUserImportance as $key => $importance) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $importance['channelname'] ?></td>
