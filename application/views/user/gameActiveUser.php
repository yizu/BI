...
<div class="bodywrapper">
    ...
    <div class="overviewhead">
        ...
        <div class="overviewhead">
            <form action="<?php echo site_url('/Game/GameCommon/findactiveUser') ?>" method="post" onsubmit="return check()">
                &nbsp;&nbsp;&nbsp;&nbsp;时间段：
        ...
        <form id="download" action="<?php echo site_url('Export/daochu/') ?>" method="post" >
            ...
            ?>'/>
            <input id="title" type="hidden" name="title" value="<?php echo '时间|平台|渠道|活跃|周活跃|月活跃,date|roofGarden|channel|day|week|month' ?>"/>
        </form>
        <br clear="all" />
        <br clear="all" />
        <br clear="all" />
