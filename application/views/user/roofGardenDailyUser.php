...
<div class="bodywrapper">
    ...
    <div class="overviewhead">
        ...
        <div class="overviewhead">
            <form action="<?php echo site_url('user/User/finddailyUser') ?>" method="post" onsubmit="return check()">
                &nbsp;&nbsp;&nbsp;&nbsp;时间段：
                ...
                <select hidden name="channelid" ><!-- 渠道 -->
        ...
        <form id="download" action="<?php echo site_url('Export/daochu/') ?>" method="post" >
            ...
            ?>'/>
            <input id="title" type="hidden" name="title" value="<?php echo '时间|平台|注册|活跃|付费人数|收入(元)|付费渗透率|arppu|活跃arppu,date|pingtai|zhucerenshu|huoyue|number|total_fee|fufeishentou|arppu|活跃arppu' ?>"/>
        </form>
        <br clear="all" />
        <br clear="all" />
        <br clear="all" />
