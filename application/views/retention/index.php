...
<div class="bodywrapper">
    ...
    <div class="overviewhead">
        ...
        <div class="overviewhead">
            <form onsubmit="return check()" action="<?php echo site_url('retention/index/getRetentionData') ?>" method="post" >
        ...
        <form id="download" action="<?php echo site_url('Export/daochu/') ?>" method="post" >
            ...
            ?>'/>
            <input id="title" type="hidden" name="title" value="<?php echo '时间|平台|注册|次日留存率|3日留存率|7日留存率|14日留存率|30日留存率,time|pingtai|registercount|ciriretentionlv|sanriretentionlv|qiriretentionlv|shisiriretentionlv|sanshiriRetentionlv' ?>"/>
        </form> 
        <br clear="all" />
        <br clear="all" />
        <br clear="all" />
