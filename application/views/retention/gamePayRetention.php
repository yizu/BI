...
<div class="bodywrapper">
    ...
    <div class="overviewhead">
        ...
        <div class="overviewhead">
            <form onsubmit="return check()" action="<?php echo site_url('Game/GameCommon/getPayRetentionData') ?>" method="post" >
                ...
                <select  name="roofGarden">
                    <option value="all" <?php echo set_select('roofGarden', ''); ?>>全部</option>
                ...
                <select name="channelid" >
                    <option value="all" <?php echo set_select('channelid', ''); ?> >全部</option>
        ...
        <form id="download" action="<?php echo site_url('Export/daochu/') ?>" method="post" >
            ...
            ?>'/>
            <input id="title" type="hidden" name="title" value="<?php echo '时间|平台|渠道|付费用户数|次日留存率|3日留存率|7日留存率|14日留存率|30日留存率,time|pingtai|channelname|paycount|ciriretentionlv|sanriretentionlv|qiriretentionlv|shisiriretentionlv|sanshiriRetentionlv' ?>"/>
        </form> 
        <br clear="all" />
        <br clear="all" />
        <br clear="all" />
